const popupData = {
  ssbmobile: {
    kicker: "Stealth Safety Bank Mobile System",
    title: "Stealth Safety Bank Mobile System",
    subtitle: "ระบบความปลอดภัยทางการเงินแบบแยกความเสี่ยง ที่ออกแบบทั้งโครงสร้าง ไม่ได้พึ่งแค่อุปกรณ์เพียงชิ้นเดียว",
    lead: "Stealth Safety Bank Mobile System คือระบบที่ออกแบบมาเพื่อลดความเสี่ยงตั้งแต่ต้นทาง โดยแยกหน้าที่ของอุปกรณ์แต่ละชิ้นอย่างชัดเจน ทำให้การเก็บเงิน การใช้งาน และการรับความเสี่ยงไม่ปะปนกัน จึงช่วยลดโอกาสการถูกหลอก ถูกควบคุม หรือถูกเข้าถึงโดยไม่ได้รับอนุญาตได้อย่างเป็นระบบ",
    badges: [
      "ระบบแยกความเสี่ยง",
      "ลดช่องทางโจมตี",
      "ออกแบบทั้งโครงสร้าง",
    ...
    features: [
      "รวมองค์ประกอบสำคัญของระบบไว้ครบ ได้แก่ SSB, SB, Flare และวิธีการใช้งานที่ควบคุมความเสี่ยง",
      "แยกหน้าที่ของอุปกรณ์อย่างชัดเจน ทำให้เครื่องเก็บเงินไม่ต้องรับความเสี่ยงจากการใช้งานทั่วไป",
      "ลดโอกาสความเสียหายจากการหลอกลวงหรือการโจมตี เพราะความเสี่ยงไม่ถูกปล่อยให้เข้าถึงระบบทั้งหมดพร้อมกัน"
    ],
    impacts: [
      { value: "แยกชัด", label: "เก็บเงิน ใช้งาน และรับความเสี่ยง ถูกแยกหน้าที่ออกจากกัน" },
      { value: "ลดเสี่ยง", label: "ตัดความเสี่ยงจากการปะปนการใช้งานและการเข้าถึงที่ไม่จำเป็น" },
      { value: "คุมได้", label: "ทุกขั้นตอนอยู่ภายใต้หลักการใช้งานที่ชัดเจนและตรวจสอบได้" }
    ],
    useCases: [
      "ผู้ที่ต้องการระบบเก็บเงินที่ไม่ปะปนกับมือถือใช้งานประจำวัน",
      "ผู้ที่ต้องการลดความเสี่ยงจากคอลเซ็นเตอร์ ฟิชชิง และการหลอกให้โอนเงิน",
      "ผู้ที่ต้องการระบบที่เข้าใจง่าย แต่มีหลักการความปลอดภัยชัดเจน"
    ],
    video: "https://www.youtube-nocookie.com/embed/mD9i39genW8",
    videoNote: "ระบบนี้ประกอบด้วย 4 ส่วนหลัก คือ SSB, SB, Flare และวิธีการใช้งาน โดยหัวใจสำคัญคือการแยกหน้าที่เพื่อควบคุมความเสี่ยง"
  },
  ...
  stealthbank: {
    ...
    lead: "Stealth Safety Bank หรือ SSB คือเครื่องที่ออกแบบมาเพื่อทำหน้าที่เฉพาะด้านการเก็บเงิน ไม่ใช่เครื่องใช้งานทั่วไป ไม่ใช้พูดคุย ไม่ใช้เล่น ไม่ใช้ติดต่อใคร และไม่ควรใช้โอนให้บุคคลอื่นโดยตรง เพราะหน้าที่ของเครื่องนี้คือเป็นจุดเก็บเงินหลักของระบบเท่านั้น",
    badges: [
      "เครื่องเก็บเงินหลัก",
      "ไม่ใช้ชีวิตประจำวัน",
      "ไม่โอนตรงหาคนอื่น",
    ...
    features: [
      "ใช้สำหรับเก็บเงินและโอนเข้า Flare เท่านั้น เพื่อลดการปะปนกับกิจกรรมที่เพิ่มความเสี่ยง",
      "ไม่ควรติดตั้งหรือใช้งานในลักษณะของมือถือทั่วไป เพราะยิ่งใช้งานหลายหน้าที่ ยิ่งเพิ่มโอกาสเกิดความผิดพลาด",
      "เป็นหัวใจหลักของการแยกความเสี่ยงในระบบ เพราะ SSB ต้องไม่ยุ่งกับโลกภายนอกเกินความจำเป็น"
    ],
    impacts: [
      { value: "นิ่ง", label: "ลดความเสี่ยงจากการใช้งานจิปาถะที่ไม่เกี่ยวกับการเก็บเงิน" },
      { value: "ชัด", label: "ทำหน้าที่เดียวอย่างตรงไปตรงมา คือเก็บเงินและโอนเข้า Flare" },
      { value: "ปลอดภัยขึ้น", label: "ยิ่งไม่ปะปน ยิ่งลดโอกาสการเสียหายจากการถูกหลอกหรือถูกเจาะ" }
    ],
    useCases: [
      "ใช้เป็นเครื่องเก็บเงินหลักของระบบ",
      "ใช้โอนเข้า Flare เมื่อต้องการใช้งานเงินจริง",
      "ใช้ในระบบที่ต้องการแยกเงินออกจากความเสี่ยงโดยตรง"
    ],
    video: "https://www.youtube-nocookie.com/embed/mD9i39genW8",
    videoNote: "SSB ไม่ใช่เครื่องใช้งานทั่วไป แต่เป็นเครื่องเก็บเงินหลักของระบบ และไม่ควรโอนให้ใครโดยตรง"
  },
  ...
  safetybook: {
    ...
    lead: "Stealth Safety Book หรือ SB คือกล่องเก็บที่ภายนอกดูเหมือนหนังสือทั่วไป แต่ภายในมีหน้าที่สำคัญในการเก็บ SSB และช่วยลดโอกาสการเข้าถึงจากภายนอก ทั้งยังช่วยอำพรางไม่ให้ระบบดูโดดเด่นหรือถูกสังเกตได้ง่าย",
    badges: [
      "อำพรางเหมือนหนังสือ",
      "กันสัญญาณ",
      "เก็บ SSB",
    ...
    features: [
      "ลดการถูกสังเกตด้วยรูปลักษณ์ที่ดูกลมกลืนเหมือนของใช้ทั่วไป",
      "ทำหน้าที่เป็นชั้นป้องกันเพิ่มเติมก่อนจะเข้าถึง SSB ได้จริง",
      "ช่วยให้ระบบมีทั้งความปลอดภัยเชิงกายภาพและความปลอดภัยเชิงการจัดเก็บ"
    ],
    impacts: [
      { value: "แนบเนียน", label: "ไม่ดึงดูดความสนใจเหมือนกล่องหรือตู้เซฟทั่วไป" },
      { value: "ซ่อนระบบ", label: "ช่วยลดโอกาสการพบเจอหรือเข้าถึง SSB จากภายนอก" },
      { value: "เสริมชั้น", label: "ทำให้ระบบมีความครบถ้วนมากขึ้นทั้งกายภาพและการใช้งาน" }
    ],
    useCases: [
    ...
    video: "https://www.youtube-nocookie.com/embed/mD9i39genW8",
    videoNote: "SB คือส่วนที่ช่วยอำพรางและกันสัญญาณ เพื่อปกป้อง SSB ทั้งทางกายภาพและจากการตรวจจับ"
  },

  technology: {
    kicker: "Flare",
    title: "Flare (เครื่องล่อเป้า)",
    subtitle: "เครื่องสำหรับใช้งานจริง ที่ทำหน้าที่รับความเสี่ยงแทน SSB",
    ...
    features: [
      "ใช้เป็นเครื่องกลางสำหรับการใช้งานภายนอกทั้งหมด แทนที่จะนำความเสี่ยงไปปะปนกับ SSB",
      "ช่วยจำกัดวงความเสียหาย หากมีการหลอกลวงหรือการโจมตีเกิดขึ้น",
      "เป็นจุดเชื่อมระหว่างระบบเก็บเงินกับโลกภายนอก โดยไม่ทำให้ SSB ต้องสัมผัสความเสี่ยงโดยตรง"
    ],
    impacts: [
      { value: "ล่อเป้า", label: "ให้ Flare รับความเสี่ยงแทน SSB โดยตรง" },
      { value: "จำกัดวง", label: "หากเกิดปัญหา ความเสียหายจะอยู่ที่ Flare ไม่ลามถึงระบบเก็บเงินหลัก" },
      { value: "ใช้งานจริง", label: "เป็นเครื่องสำหรับโอน ใช้จ่าย และติดต่อภายนอก" }
    ],
    useCases: [
      "ใช้รับเงินจาก SSB ก่อนนำไปใช้จริง",
      "ใช้โอนให้บุคคลอื่นแทนการใช้ SSB โดยตรง",
      "ใช้เป็นเครื่องภายนอกที่ยอมรับความเสี่ยงแทนระบบหลัก"
    ],
    video: "https://www.youtube-nocookie.com/embed/mD9i39genW8",
    videoNote: "Flare คือเครื่องที่ใช้ทำธุรกรรมจริง และทำหน้าที่รับความเสี่ยงแทน SSB"
  },

  aboutcompany: {
    kicker: "Key System",
    title: "วิธีการใช้งาน",
    subtitle: "กฎการใช้งานคือหัวใจของความปลอดภัยทั้งหมด หากใช้งานไม่ถูก ระบบจะเสียความหมายทันที",
    lead: "ระบบนี้จะปลอดภัยได้ ไม่ใช่เพราะมีอุปกรณ์หลายชิ้นเท่านั้น แต่เพราะมีวิธีการใช้งานที่ชัดเจนและเคร่งครัด โดยกฎสำคัญที่สุดคือ SSB ใช้เพื่อเก็บเงินและโอนเข้า Flare เท่านั้น ห้ามโอนให้บุคคลอื่นโดยตรง ไม่ว่าจะเป็นใครก็ตาม",
    badges: [
      "หัวใจของระบบ",
      "SSB โอนได้แค่ Flare",
      "ห้ามปะปนการใช้งาน",
    ...
    features: [
      "SSB ใช้เพื่อเก็บเงินและโอนเข้า Flare เท่านั้น ห้ามใช้โอนให้บุคคลอื่นโดยตรง",
      "หากต้องการโอนให้ใคร ต้องโอนไปที่ Flare ก่อน แล้วค่อยให้ Flare โอนไปต่อ",
      "การแยกบทบาทระหว่าง SSB และ Flare คือหัวใจของระบบทั้งหมด หากปะปนกัน ความปลอดภัยจะลดลงทันที"
    ],
    impacts: [
      { value: "ชัดเจน", label: "รู้ทันทีว่าเครื่องไหนทำหน้าที่อะไร และห้ามใช้แทนกัน" },
      { value: "ลดพลาด", label: "เมื่อมีกฎที่ชัด จะลดโอกาสความผิดพลาดจากการใช้งานจริง" },
      { value: "ปลอดภัยจริง", label: "ความปลอดภัยเกิดจากวินัยในการใช้ ไม่ใช่แค่อุปกรณ์" }
    ],
    useCases: [
      "เปิด SB แล้วนำ SSB ออกมาใช้งานเฉพาะตอนจำเป็น",
      "โอนจาก SSB เข้า Flare ก่อนทุกครั้ง หากต้องใช้งานภายนอก",
      "ปิดเครื่องและเก็บกลับ SB ทันทีหลังใช้งานเสร็จ"
    ],
    video: "https://www.youtube-nocookie.com/embed/mD9i39genW8",
    videoNote: "วิธีการใช้งานคือ Key System ของระบบนี้ และเป็นสิ่งที่ต้องยึดถืออย่างเคร่งครัด"
  }
};
