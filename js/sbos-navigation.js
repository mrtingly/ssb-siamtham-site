...
window.SBOS_NAV = {
  agent: [
    ...
    ["team-manager-dashboard.html", "Team Manager"],
    ["area-manager-dashboard.html", "Area Manager"],
  ...
  admin: [
    ...
    ["admin-organization.html", "Organization"],
    ["admin-areas.html", "Areas"],
    ["admin-teams.html", "Teams"],
    ["admin-agent-assignments.html", "Assignments"],
